...
impl State {
    ...
    async fn new(window: &Window) -> Self {
        ...
        let dimensions: (i32, i32) = (400, 400);
        let diffuse_texture = Texture::test(&device, &queue, Some("test")).unwrap();
        ...
        // TODO
        let vs_module =
            device.create_shader_module(wgpu::include_spirv!("wgpu_layer/shader.vert.spv"));
        let fs_module =
            device.create_shader_module(wgpu::include_spirv!("wgpu_layer/shader.frag.spv"));
    ...
    fn input(&mut self, event: &WindowEvent) -> bool {
        ...
        //                 .create_buffer_init(&wgpu::util::BufferInitDescriptor {
        //                     label: Some("Index Buffer"),
        //                     contents: bytemuck::cast_slice(INDICES_TRIANGLE),
        //                     usage: wgpu::BufferUsage::INDEX,
        //                 });

        //         self.num_indicies = INDICES_TRIANGLE.len() as u32;
        //     }
        // }
        false
    }
                ...
                color_attachments: &[wgpu::RenderPassColorAttachmentDescriptor {
                    ...
                    ops: wgpu::Operations {
                        load: wgpu::LoadOp::Clear(wgpu::Color {
                            r: self.position_x / (self.size.width as f64),
                            g: self.position_y / (self.size.height as f64),
                            b: 0.3,
                            a: 1.0,
                        }),
                        store: true,
